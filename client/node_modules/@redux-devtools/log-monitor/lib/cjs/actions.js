...
exports.UPDATE_SCROLL_TOP = exports.START_CONSECUTIVE_TOGGLE = void 0;
...
const START_CONSECUTIVE_TOGGLE = '@@redux-devtools-log-monitor/START_CONSECUTIVE_TOGGLE';
exports.START_CONSECUTIVE_TOGGLE = START_CONSECUTIVE_TOGGLE;
function startConsecutiveToggle(id) {
  return {
    type: START_CONSECUTIVE_TOGGLE,
    id
  };
}